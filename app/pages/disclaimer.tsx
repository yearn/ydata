		...
		<div className={'w-full'}>
			<Card>
				<div className={'flex w-full flex-row justify-between pb-6'}>
					...
					<Link href={'/'}>
						<Cross
							className={'text-typo-primary hover:text-typo-primary-variant h-6 w-6 cursor-pointer transition-colors'}
						/>
					</Link>
				</div>
				<div className={'space-y-6 text-justify'}>
					...
					<p>
						...
						<a href={'https://docs.yearn.finance'} target={'_blank'} rel={'noreferrer'} className={'link'}>
							{'documentation'}
						</a>
						{' and '}
						<a href={'https://github.com/yearn/'} target={'_blank'} rel={'noreferrer'} className={'link'}>
							{'code'}
						</a>
						{' before use.'}
					</p>
