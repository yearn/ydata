  ...
  return (
    <footer className={'mx-auto mt-auto hidden w-full max-w-6xl flex-row items-center py-8 md:flex'}>
      <Link href={'/disclaimer'}>
        <p
          className={
            'text-typo-secondary hover:text-primary cursor-pointer pr-6 text-xs transition-colors hover:underline'
          }
        >
          {'Disclaimer'}
        </p>
      ...
      <a
        ...
        target={'_blank'}
        className={'text-typo-secondary hover:text-primary pr-6 text-xs transition-colors hover:underline'}
        rel={'noreferrer'}
      >
        {'Documentation'}
      </a>
